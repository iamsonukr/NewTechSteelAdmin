...
export default function Home() {
  ...
  const fetchDashboardData = async (role) => {
    try {
      ...
      const endpoint = role === "admin"
        ? "/poster/user/dashboard-data"
        : "/poster/user/dashboard-data-user";
  ...
  return (
    <>
      <PageMeta
        title="React.js Ecommerce Dashboard | NewTechSteel - React.js Admin Dashboard Template"
        description="This is React.js Ecommerce Dashboard page for NewTechSteel - React.js Tailwind CSS Admin Dashboard Template"
      />
