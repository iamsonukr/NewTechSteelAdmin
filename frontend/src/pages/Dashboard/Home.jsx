...
export default function Home() {
  ...
  return (
    <>
      <PageMeta
        title="React.js Ecommerce Dashboard | BookMyPoster - React.js Admin Dashboard Template"
        description="This is React.js Ecommerce Dashboard page for BookMyPoster - React.js Tailwind CSS Admin Dashboard Template"
      />
