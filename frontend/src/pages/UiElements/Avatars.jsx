...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | NewTechSteel - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for NewTechSteel - React.js Tailwind CSS Admin Dashboard Template"
      />
