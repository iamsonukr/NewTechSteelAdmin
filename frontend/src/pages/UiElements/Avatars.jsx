...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | BookMyPoster - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for BookMyPoster - React.js Tailwind CSS Admin Dashboard Template"
      />
