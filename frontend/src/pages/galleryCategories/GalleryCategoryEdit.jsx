...
import { getGalleryCategoryById, updateGalleryCategory } from "../../api/services/galleryCategory.service";
import toast from "react-hot-toast";

export default function GalleryCategoryEdit() {
  const { id } = useParams();
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try { await updateGalleryCategory(id, formData); toast.success("Category updated!"); navigate("/admin-panel/gallery-categories"); }
  ...
  return (
    <div>
      <PageHeader title="Edit Gallery Category" breadcrumbs={[{ label: "Dashboard", to: "/dashboard" }, { label: "Gallery Categories", to: "/gallery-categories" }, { label: "Edit" }]} />
